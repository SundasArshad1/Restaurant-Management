   ...
   <section id="services" class="services">
    ...
    <?php
      class POSDish
      {
            ...
            {
                ?>
                <form method="post" action="dishrecord.php">
                    <table width="100%">
                        <tr><td><label>Dish ID</label></td>
                        <td><input name="dish_id"></td></tr>
                        <tr><td><label>Dish Name</label></td>
                        <td><input name="dish_name"></td></tr>
                        <tr><td><label>Dish Price</label></td>
                        <td><input name="dish_price"></td></tr>
                        <tr><td><label>Dish Quantity</label></td>
                        <td><input name="dish_qty"></td></tr>
                        <tr><td><label>Dish Type</label></td>
                        <td><input name="dish_type"></td></tr>
                        <tr><td><label>Dish Image</label></td>
                        <td><input name="dish_img"></td></tr>
            ...
            function updateDish()
            {
                ...
                <form method="post" action="dishrecord.php">
                    <table width="100%">
                        ...
                        <tr><td colspan="2"><input type="submit" value="Update Dish" name="update" class="bottom" style="margin-left:200px"></td></tr>
                </table>
                </form>
            <?php
            }
