   ...
   <section id="services" class="services">
    ...
    <?php
      class POSDish
      {
            ...
            {
                ?>
                <form method="post" action="orderrecord.php">
                    <label>Order ID</label>
                    <input name="order_id"><br></td></tr>
                    <input type="submit" value="Delete Order" name="delete" class="bottom" style='margin-left:245px;'>
                </form>
                <?php
            }
            ...
            function cancelOrder()
            {
                ...
                <form method="post" action="dishrecord.php">
                    <table width="100%">
                        ...
                        <tr><td colspan="2"><input type="submit" value="Cancel Order" name="cancel" class="bottom" style="margin-left:200px"></td></tr>
                </table>
                </form>
            <?php
            }
