...
<body>
  ...
  <!-- End Header -->
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6">
            <div class="icon-box" data-aos="fade-up">
              <div class="icon"></div>
              <h4 class="title"><a href="Customer.php">Customer</a></h4>
              <img src="images/customer.png" width="30%" height="100px">
            </div>
          </div>
          <div class="col-lg-6 col-md-6">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              <div class="icon"></div>
              <h4 class="title"><a href="Inventory.php">Inventory</a></h4>
              <img src="images/inventory.png" width="30%" height="100px">
            </div>
          </div>
          <div class="col-lg-6 col-md-6">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
              <div class="icon"></div>
              <h4 class="title"><a href="Order.php">Order</a></h4>
              <img src="images/order.png" width="30%" height="100px">
            </div>
          </div>
          <div class="col-lg-6 col-md-6">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
              <div class="icon"></div>
              <h4 class="title"><a href="dishes.php">Dish</a></h4>
             <img src="images/dish.png" width="30%" height="100px">
            </div>
          </div>
        </div>
    ...
    function saveCustomerInfo()
    {
        ...
        $sql = "INSERT INTO customer (Customer_ID,Customer_Name,Customer_Address,Email_ID,Customer_Phone_no,Order_ID) VALUES($cust_id,'$fullName','$address','$email',$mobileNumber,$order_id)";
        try 
        {
            $rows = $conn->query($sql);
        } 
