  ...
  <!-- End Header -->
   ...
   <section id="services" class="services">
      <div style="margin-bottom:-500px">
          <h1 class="title">Customer  Record</h1>
      </div>
    ...
    <?php
      class Customer
      {
          ...
          {
            ?>
            <form method="post" action="customerrecord.php">
              <label>Customer Customer ID</label>
              <input name="c_cnic">
            <input type="submit" value="search" name="search" class="bottom">
            </form>
          <?php
          }
          ...
          function deleteCustomerInfo()
          {
            ...
            <form method="post" action="customerrecord.php">
              <label>Customer Customer ID</label>
              <input name="c_cnic"><br></td></tr>
              <input type="submit" value="delete" name="delete" class="bottom">
            </form>
          <?php
          }
      }
        ...
        {
          $cus->searchCustomerInfo();
        }
        else if(isset($_POST['Delete']))
        {
          $cus->deleteCustomerInfo();
        }
      ?>
